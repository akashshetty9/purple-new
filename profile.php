    ...
    <div class="box">
        <div class="box1">
            <div class="box11">
                ...
                <label for="successful Attack">Successful  Activity:</label>
                <input type='text'class='emailid'placeholder=<?php echo $data2[0][5]; ?> required ><br>
                <label for="Unsucessful Attack">Unsucessful Activity:</label>
                <input type='text'class='emailid'placeholder=<?php echo $data2[0][6]; ?> required ><br>
        ...
        <div class="box1">
            <div class="box12">
                <div class="box121">
                    <button type='submit'class='submit-btn' class="Attack" id="btn" onclick="window.location.href = 'attackd1.html';">Attack</button>  
